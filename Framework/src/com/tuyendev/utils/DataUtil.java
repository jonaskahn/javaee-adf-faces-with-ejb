...
public class DataUtil {
    ...
    public static Collection<Long> objLstToLongLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToLong).toList();
    }

    public static Collection<Short> objLstToShortLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToShort).toList();
    }

    public static Collection<BigDecimal> objLstToBigDecimalLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToBigDecimal).toList();
    }

    public static Collection<Double> objLstToDoubleLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToDouble).toList();
    }

    public static Collection<Character> objLstToCharLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToCharacter).toList();
    }

    public static Collection<String> objLstToStringLst(List<Object> list) {
        return isNullOrEmpty(list) ? Lists.newArrayList() : StreamEx.of(list).map(DataUtil::safeToString).toList();
    }
