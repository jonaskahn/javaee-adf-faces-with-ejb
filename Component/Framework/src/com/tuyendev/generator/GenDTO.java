    ...
    private static void writeMapper(Class cl, String mapperPackage, List<String> classesType) throws Exception {
        ...
        try {
            ...
            variables.forEach((var, type) -> {
                try {
                    out.append("\n\t\t" + lowerFirst(className) + ".set"+upperFirst(var)+"(dto.get"+upperFirst(var)+"());");
            ...
            out.append("\n\t\t" + className+"DTO" + " " + lowerFirst(className+"DTO") + "= new " + className + "DTO();");
            variables.forEach((var, type) -> {
                try {
                    out.append("\n\t\t" + lowerFirst(className+"DTO") + ".set"+upperFirst(var)+"(model.get"+upperFirst(var)+"());");
