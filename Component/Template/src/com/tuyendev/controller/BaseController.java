...
import com.tuyendev.messagesender.MessageSender;
...
public class BaseController implements Serializable {
    ...
    public Map<String, ResourceBundle> getMultiBundle() {
        ...
        mlrs.put(Lang.VIETNAM.getCode(), BundleFactory.getBundle("com.tuyendev.key.lang", new Locale(Lang.VIETNAM.getCode())));
        mlrs.put(Lang.ENGLISH.getCode(), BundleFactory.getBundle("com.tuyendev.key.lang", new Locale(Lang.ENGLISH.getCode())));
        return mlrs;
    }


    public void reportSuccess(String key, Object... params) {
        MessageSender.sendSuccessMessage(getText(key, params));
    }

    public void reportWarm(String keyMess,Object... params) {
        MessageSender.sendWarningMessage(getText(keyMess, params));
    }
    ...
    public void reportError(Exception e, ADFLogger logger) {
        try {
            if (e instanceof LogicException) {
                ...
                MessageSender.sendErrorMessage(getText("hipt.app.common.message.error.system"));
                logger.severe(e);
            }
        } catch (Exception es) {
    ...
    public void reportError(String keyMess, Object... params) {
        MessageSender.sendErrorMessage(getText(keyMess, params));
    }
    ...
    public String getText(String key, Object... params) {
        try {
            ...
            if (!DataUtil.isNullOrEmpty(params)) {
                values = StreamEx.of(params).map(Object::toString).toArray(String.class);
            }
