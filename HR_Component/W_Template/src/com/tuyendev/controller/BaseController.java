...
public class BaseController implements Serializable {
    ...
    public Map<String, ResourceBundle> getMultiBundle() {
        ...
        mlrs.put(Lang.VIETNAM.getCode(),
                 BundleFactory.getBundle("com.tuyendev.key.lang", new Locale(Lang.VIETNAM.getCode())));
        mlrs.put(Lang.ENGLISH.getCode(),
                 BundleFactory.getBundle("com.tuyendev.key.lang", new Locale(Lang.ENGLISH.getCode())));
        return mlrs;
    }
    ...
    public void reportError(Exception e, ADFLogger logger) {
        try {
            if (e instanceof LogicException) {
                ...
                Messenger.sendErrorMessage(getText("hipt.app.common.message.error.system"));
                logger.severe(e);
            }
        } catch (Exception es) {
