...
public class GetText {
    ...
    private static Properties getProperties() {
        prop = new Properties();
        try {
            lang = GetText.class.getClassLoader().getResourceAsStream("com/tuyendev/resources/lang.properties");
            prop.load(lang);
        } catch (IOException e) {
            logger.severe(e.getMessage());
            try {
                lang_vi = GetText.class.getClassLoader().getResourceAsStream("com/tuyendev/resources/lang_vi.properties");
                prop.load(lang_vi);
            } catch (IOException f) {
                logger.severe(e.getMessage());
            }
